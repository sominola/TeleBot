...
public class YoutubeHandler(ILogger logger, IHttpClientFactory factory) : IMessageHandler
{
    private readonly HttpClient _prostoyClient = factory.CreateClient("Prostoy");
    ...
    private static HttpRequestMessage BuildMessage(string url)
    {
        ...
        var req = new HttpRequestMessage(HttpMethod.Post, "https://co.wuk.sh/api/json")
        {
